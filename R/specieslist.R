...
#'
#' NOTE March 2017: the response object might include records with missing taxonomic information. This is an issue with the NBN server-side systems; see https://github.com/AtlasOfLivingAustralia/bie-index/issues/134
#' 
