...
#'
#' @references Associated ALA web service: \url{https://species-ws.nbnatlas.org/}
#'  
...
search_fulltext <- function(query,fq,output_format="simple",start,page_size,sort_by,sort_dir) {
    ...
    this_url <- build_url_from_parts(getOption("ALA4R_server_config")$base_url_bie,"search",query=this_query)
